...
Em.mver="MEASUREMENT_VERSION_",Em.pis="PLAYER_INITIALIZED_STATE_",Em.yt_pt="LATENCY_PLAYER_",Em.pa="LATENCY_ACTION_",Em.ctop="TOP_ENTITY_TYPE_",Em.yt_vst="VIDEO_STREAM_TYPE_",Em),Gm="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
